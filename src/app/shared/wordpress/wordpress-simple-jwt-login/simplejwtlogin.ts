...
import { AutologinInterface } from "./interfaces/AutologinInterface";
...
import { RefreshTokenInterface } from "./interfaces/RefreshTokenInterface";
...
import { RevokeTokenInterface } from "./interfaces/RevokeTokenInterface";
import { ValidateTokenInterface } from "./interfaces/ValidateTokenInterface";
export class SimpleJwtLogin {
   ...
   */
  public autologin(params: any, authCode = "") {
    if (authCode !== "") {
